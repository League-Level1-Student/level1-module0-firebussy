...
public class MagicBox extends JPanel implements Runnable, MouseListener {
	...
	private static void playMusicOnComputer(String string) {
		// TODO Auto-generated method stub
		
	}

	private static void loadImageFromHardDrive(String string) {
		// TODO Auto-generated method stub
	...
	public void mousePressed(MouseEvent e) {
		...
		System.out.println(e.getY());
		 if (e.getX()>204&& e.getY()>542){
			   playMusicOnComputer("song.mp3");
		 }
		 if (e.getX()==351&& e.getY()==660){
			  loadImageFromHardDrive("color");
